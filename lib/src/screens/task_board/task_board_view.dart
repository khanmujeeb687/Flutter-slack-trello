                            ...
                            children: [
                              Scrollbar(
                                ...
                                child: RefreshIndicator(
                                  ...
                                  onRefresh: () async {
                                    await _taskBoardController.fetchBoard(widget.roomId);
                                  },
                                  child: SingleChildScrollView(
                                    controller:
                                        _taskBoardController.scrollController,
                                    child: Column(
                                      mainAxisAlignment:
    ...
    return Card(
      ...
      child: Container(
        ...
        child: ListTile(
          ...
          title: Text(
            task.title,
            style: TextStyle(color: EColors.themeBlack),
          ),
          subtitle: Column(
